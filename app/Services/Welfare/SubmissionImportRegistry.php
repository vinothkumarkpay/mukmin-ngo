...
class SubmissionImportRegistry
{
    ...
    public function exampleRow(): array
    {
        $examples = [
            ...
            'friends' => [
                'Individual', '', '', '', '', '', '', '',
                'Ahmad bin Ali', '900101011234', 'Selangor', 'No 1, Jalan Example',
                'ahmad@example.com', '+60123456789', 'Community Engagement & Volunteering',
            ],
            'mentor' => [
            ...
            'mfls' => [
                ...
                'SPM', 'SMK Example', '3.50', 'Foundation in Science', 'Yes', 'No',
                '< RM2,000', 'Ali bin Abu', 'Driver', 'Siti binti Omar', 'Housewife',
                '4', '', 'Prefect', 'Active', 'Yes',
    ...
    private function transform(array $data): array
    {
        switch ($this->type) {
            case 'ordinary':
                ...
                unset(
                    $data['president_name'], $data['president_email'], $data['president_phone'],
                    $data['secretary_name'], $data['secretary_email'], $data['secretary_phone'],
                    $data['treasurer_name'], $data['treasurer_email'], $data['treasurer_phone']
                );
        ...
        return [
            ...
            'ordinary' => [
                ...
                'columns' => [
                    ...
                    'registered_state' => ['label' => 'State', 'required' => true],
                    'full_address' => ['label' => 'Address', 'required' => true],
            ...
            'mfls' => [
                ...
                'columns' => [
                    ...
                    'programme_course_applied' => ['label' => 'Programme Applied', 'required' => true],
                    'applied_to_university' => ['label' => 'Applied to University', 'required' => true, 'type' => 'boolean'],
                    'received_offer_letter' => ['label' => 'Offer Letter Received', 'type' => 'boolean'],
                    ...
                    'leadership_roles' => ['label' => 'Leadership Roles', 'required' => true],
                    'involvement_level' => ['label' => 'Involvement Level', 'required' => true],
                    'community_service_involvement' => ['label' => 'Community Service', 'required' => true],
